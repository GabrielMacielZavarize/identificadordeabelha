...
from augochloropsis_ai.schemas.species import SpeciesCreate, SpeciesRead, SpeciesUpdate
from augochloropsis_ai.services.species_service import SpeciesService
